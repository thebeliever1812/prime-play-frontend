...
const WatchHistoryCardSkeleton = ({ className }: WatchHistoryCardSkeletonProps) => {
    return (
        <div
            className={cn(
                "flex flex-col sm:flex-row gap-3 sm:gap-4 p-3 rounded-xl",
                "animate-pulse",
                className
            )}
        >
            {/* Thumbnail skeleton */}
            <div className="relative w-full sm:w-56 md:w-64 shrink-0 aspect-video rounded-lg bg-zinc-200 overflow-hidden">
                <div
                    className="absolute inset-0 bg-gradient-to-r from-transparent via-zinc-300/40 to-transparent animate-shimmer"
            ...
            {/* Options skeleton */}
            <div className="shrink-0 self-start pt-1 hidden sm:block">
